...
describe('ChangeFine', () => {
    ...
    async function setFine(timestamp: Date, variant: boolean = false) {
    ...
    it('Fine set', async () => {
        await setFine(new Date('2011-10-15T10:42:38+0000'));
    ...
    it('Fine update custom reason', async () => {
        await setFine(new Date('2011-10-15T10:42:38+0000'));
        await setFine(new Date('2011-10-16T10:42:38+0000'), true);
